        ...
        distanceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(autoCompView.getText().toString()) &&
                        !TextUtils.isEmpty(autoCompView2.getText().toString())) {
                    ...
                    Toast.makeText(FareCalculatorActivity.this, "Please enter complete details to continue.", Toast.LENGTH_SHORT).show();
                }
            }
        });
